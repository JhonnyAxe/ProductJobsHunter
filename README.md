...
### Умный парсер вакансий продакт-менеджеров из Telegram с GPT анализом
...
Product Jobs Hunter - это умный инструмент для мониторинга и анализа вакансий продуктовых менеджеров в Telegram каналах. Использует GPT для определения релевантности вакансий и автоматически отправляет уведомления о новых предложениях работы.

### ✨ Особенности
- 🤖 **AI-Powered анализ** - Использует GPT для оценки релевантности продуктовых ролей
...
- 🔍 **Умный поиск** - Распознавание различных вариантов написания Product Manager/Owner
...
2. 🔍 Ищет сообщения с ключевыми словами для Product Manager/Owner (product, продакт и т.д.)
...
- `product_channels.py` - список каналов для мониторинга
